...
def stats(data, percs=(0,25,50,75,100)):
    percs = np.percentile(data, (0,25,50,75,100))
    return percs


def holostats(vals: npt.ArrayLike, percs: Optional[npt.ArrayLike] = None, prec: int = 2, weights=None) -> str:
    """Return a string giving quantiles of the given input data. Stolen from nanograv/holodeck
