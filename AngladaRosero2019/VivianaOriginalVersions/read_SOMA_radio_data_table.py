...
radio_dat = np.genfromtxt( '/Users/Vivi/postdoc_UF/SOMA/codes/spectral_index/new_version_spectral_index/SOMA_Radio_data_table_core_v2.txt', names=True, dtype=None )
...
radio_dat_lit = np.genfromtxt( '/Users/Vivi/postdoc_UF/SOMA/codes/SED/tables_fluxes_SOMA/soma_flux_lit.txt', names=True, dtype=None )
...
infrared_data = np.genfromtxt( '/Users/Vivi/postdoc_UF/SOMA/codes/spectral_index/new_version_spectral_index/SOMA_infrared_data_table.txt' , names=True, dtype=None )
