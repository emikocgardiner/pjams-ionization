...
Yichen_models_dict_dir ='AngladaData/Yichen_models_dict.p'
Yichen_models_dict = pickle.load( open( Yichen_models_dict_dir, 'rb' ) )


radio_SOMA_dict_dir ='AngladaData/radio_SOMA_dict.p'
radio_SOMA_dict = pickle.load( open( radio_SOMA_dict_dir, 'rb' ) )

best_Yichen_fits_dict_dir_new_model_Kei ='AngladaData/best_Yichen_fits_dict_new_model_Kei.p'
best_Yichen_fits_dict_new_model_Kei = pickle.load( open( best_Yichen_fits_dict_dir_new_model_Kei, 'rb' ) )

best_Yichen_fits_dict_dir ='AngladaData/best_Yichen_fits_dict.p'
best_Yichen_fits_dict = pickle.load( open( best_Yichen_fits_dict_dir, 'rb' ) )


SOMA_sources_dir =\
                   'AngladaData/SOMA_sources.npy'
...
infile_M60 = 'AngladaData/mcore60.sigma1.dat'
...
lum_bol_tab = 'AngladaData/latex_tab_chi2_models_v3.txt'
...
pickle.dump( data_dict_Lit, open( 'AngladaData/data_dict_Lit.p', 'wb' ) )
...
##Reading the input from the table
infile='AngladaData/Survey_momentum_rate_v4/'
